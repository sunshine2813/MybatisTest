...
(function (m) {
    ...
    q = function (c, a) {
        if (a.chkDisabled === !0)return !1;
        var b = f.getSetting(c.data.treeId), d = n(a, h.id.CHECK, b);
        a.check_Focus = !0;
        e.setChkClass(b, d, a);
        return !0
    };
        ...
        tools: {}, view: {
            checkNodeRelation: function (c, a) {
                ...
                if (c.check.chkStyle == d.STYLE) {
                    ...
                    if (b)if (c.check.radioType == d.TYPE_ALL) {
                        for (d = g.length - 1; d >= 0; d--) {
                            ...
                            k && b != a && (f.nodeChecked(c, b, !1), g.splice(d, 1), e.setChkClass(c,
                        ...
                        for (d = 0, j = g.length; d < j; d++)if (b = g[d], (k = f.nodeChecked(c, b)) && b != a)f.nodeChecked(c, b, !1), e.setChkClass(c, n(b, h.id.CHECK, c), b)
                    } else if (c.check.radioType == d.TYPE_ALL)for (d = 0, j = g.length; d < j; d++)if (a == g[d]) {
                        g.splice(d, 1);
                        break
                    }
                } else g = f.nodeChildren(c, a), b && (!g || g.length == 0 || c.check.chkboxType.Y.indexOf("s") > -1) && e.setSonNodeCheckBox(c, a,
                ...
                if (a) {
                    ...
                    if ((a = f.nodeChildren(c, a)) && d)for (var j = 0, g = a.length; j < g; j++)e.repairSonChkDisabled(c,
                        a[j], b, d)
                }
                ...
                d || (d = a);
                f.makeChkFlag(c, a);
                a.nocheck !== !0 && a.chkDisabled !== !0 && (f.nodeChecked(c, a, b), e.setChkClass(c, j, a), c.check.autoCheckTrigger && a != d && c.treeObj.trigger(h.event.CHECK,
                    [null, c.treeId, a]));
                if (a.parentTId) {
                    j = !0;
                    if (!b)for (var g = f.nodeChildren(c, a.getParentNode()), k = 0, w = g.length; k < w; k++) {
                        var l = g[k], i = f.nodeChecked(c, l);
            ...
            getRadioCheckedList: function (c) {
                ...
                for (var j = b && c.check.chkStyle == h.radio.STYLE && c.check.radioType == h.radio.TYPE_ALL, d = !d ? [] : d, g = 0, e = a.length; g < e; g++) {
                    var i =
                        a[g], l = f.nodeChildren(c, i), m = f.nodeChecked(c, i);
                ...
                for (var b = !b ? [] : b, d = 0, j = a.length; d < j; d++) {
                    var g = a[d], e = f.nodeChildren(c, g), h = f.nodeChecked(c, g);
                ...
                if (a) {
                    ...
                    if (d)for (var j = 0, g = d.length; j < g; j++) {
                        var e = d[j], i = f.nodeChecked(c, e), l = -1;
                        if (c.check.chkStyle == h.radio.STYLE)if (l = e.nocheck === !0 || e.chkDisabled === !0 ? e.check_Child_State : e.halfCheck === !0 ? 2 : i ? 2 : e.check_Child_State > 0 ? 2 : 0, l == 2) {
                            b = 2;
                            break
                        } else l == 0 && (b = 0); else if (c.check.chkStyle == h.checkbox.STYLE)if (l = e.nocheck === !0 || e.chkDisabled === !0 ? e.check_Child_State : e.halfCheck === !0 ? 1 : i ? e.check_Child_State === -1 || e.check_Child_State === 2 ? 2 : 1 : e.check_Child_State > 0 ? 1 : 0, l === 1) {
                            b = 1;
                            break
    ...
    var m = m.fn.zTree, i = m._z.tools, h = m.consts, e = m._z.view, f = m._z.data, n = i.$;
    ...
    f.addInitNode(function (c, a, b, d) {
        if (b) {
            ...
            if (typeof b.halfCheck == "string")b.halfCheck = i.eqs(b.halfCheck,
                "true");
    ...
    f.addInitProxy(function (c) {
        var a = c.target, b = f.getSetting(c.data.treeId), d = "", e = null, g = "", k = null;
        ...
        return {
            ...
            treeEventType: "", treeEventCallback: null
        }
    }, !0);
    ...
    f.addZTreeTools(function (c, a) {
        a.checkNode = function (a, b, g, k) {
            ...
            if (a.chkDisabled !== !0 && (b !== !0 && b !== !1 && (b = !m), k = !!k, (m !== b || g) && !(k && i.apply(this.setting.callback.beforeCheck,
        ...
        a.updateNode = function (c, f) {
            ...
            if (c && this.setting.check.enable && n(c, this.setting).get(0) &&
                i.uCanDo(this.setting)) {
